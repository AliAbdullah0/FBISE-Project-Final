                    ...
                    <div className='w-full flex gap-3 items-center'>
                        <div className='flex items-center justify-evenly md:flex-row flex-col w-full md:gap-2 flex-wrap gap-4'>
                            <div class="relative flex flex-col justify-center overflow-hidden sm:py-12">
                                <div
                                    class="group relative cursor-pointer overflow-hidden bg-gradient-to-t from-indigo-400 to-pink-400 px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl sm:mx-auto sm:max-w-sm sm:rounded-lg sm:px-10">
                                    <span class="absolute top-10 z-0 h-20 w-20 rounded-full bg-black transition-all duration-300 group-hover:scale-[10]"></span>
                                    <div class="relative z-10 mx-auto max-w-md">
                                        <span class="grid h-20 w-20 place-items-center rounded-full bg-cyan-400 transition-all duration-300 group-hover:bg-sky-400">
                                        ...
                                        <div class="pt-6 text-base font-semibold leading-7">
                                            <p>
                                                <Link to='imagerecognition' class="text-pink-500 transition-all duration-300 group-hover:text-white">Try Model
                                                    &rarr;
                                                </Link>
                                            </p>
                                        </div>
                            ...
                            <div class="relative flex flex-col justify-center overflow-hidden sm:py-12">
                                <div
                                    ...
                                    <div class="relative z-10 mx-auto max-w-md">
                                        ...
                                        <div class="pt-6 text-base font-semibold leading-7">
                                            <p>
                                                <Link to='gpt' class="text-pink-500 transition-all duration-300 group-hover:text-white">Try Model
                                                    &rarr;
                                                </Link>
                                            </p>
                                        </div>
                            ...
                            <div class="relative flex flex-col justify-center overflow-hidden sm:py-12">
                                <div
                                    ...
                                    <div class="relative z-10 mx-auto max-w-md">
                                        ...
                                        <div class="pt-6 text-base font-semibold leading-7">
                                            <p>
                                                <Link to='objrec' class="text-pink-500 transition-all duration-300 group-hover:text-white">Try Model
                                                    &rarr;
                                                </Link>
                                            </p>
                                        </div>
